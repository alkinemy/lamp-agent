...
@Getter
@Setter
@ConfigurationProperties(prefix = "lamp.client", ignoreUnknownFields = false)
public class LampClientProperties implements ApplicationListener<ApplicationEvent> {
	...
	public void init() throws UnknownHostException {
		...
		if (StringUtils.isBlank(version)) {
			version = LampClientProperties.class.getPackage().getImplementationVersion();
		}
	}
